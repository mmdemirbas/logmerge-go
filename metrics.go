...
func PrintMetrics(startTime time.Time, elapsedTime time.Duration, err error) {
	...
	fmt.Fprintf(Stderr, "  max line length       : %8s ~ %15d\n", "", LineLengths.max)
